...
Навіщо: окремі AI-відправники (астро-алерти, теми, відкритість, самодії)
раніше стріляли кілька разів на годину кожен. Це і спам, і зайві кредити
Gemini. Тепер кожен із них має рівно ОДИН дозвіл на годинний слот.
Під воротами лише описові AI-блоки без власного дедупу: теми/відкритість
(openmind). Здоров'я (hcoach) з 21.09 НЕ під воротами — має власний дедуп
по дню/слоту і має реагувати миттєво (напр. одразу після нових даних), а не
чекати до наступної години. Нагадування, алерти, сповіщення та власні
пропозиції AI під ворота НЕ йдуть — вони спрацьовують тоді, коли є причина:
подія, лист, рух ціни, прострочене. Щогодинний звіт іде своїм шляхом і
воротами не обмежений.
"""
