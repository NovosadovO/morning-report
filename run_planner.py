...
AI сам дивиться:
  ...
  🏃 ручний трекер бігу (running.py) — скільки бігав останні 2 тижні, темп, кілометраж
...
def _run_context() -> dict:
    ctx = {"ok": False, "text": "дані про біг недоступні", "runs_7d": 0, "km_7d": 0.0}
    try:
...
🏃 ЙОГО РЕАЛЬНІ ДАНІ ПРО БІГ (ручний запис від нього самого):
{strava}
