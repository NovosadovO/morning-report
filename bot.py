...
# ─── УНІВЕРСАЛЬНИЙ ГЕЙТ: ПЕРЕПИТАТИ ПЕРЕД БУДЬ-ЯКОЮ НЕЗВОРОТНОЮ КНОПКОЮ ──────
# Олег: «після КОЖНОГО нагадування та сповіщення» — тому перепит стоїть не в
# окремих модулях, а один раз у _route_callback і накриває всі префікси нижче.
# prefix -> (питання, кнопка «так», кнопка «ні», текст після підтвердження,
#            як повернути назад)
_CONFIRM_GATE = {
    # ── «не потрібно нагадувати» ─────────────────────────────────────────────
    "cal_skip_":     ("Не додаватиму {subject} у календар і більше не нагадаю про це.",
                      "✅ Так, не нагадуй", "↩️ Ні, залиш нагадування",
                      "🚫 Не нагадуватиму.", "Напиши мені текстом — поверну нагадування."),
    "shop_skip_":    ("Не додаватиму {subject} у список покупок.",
                      "✅ Так, пропусти", "↩️ Ні, додай",
                      "🚫 Пропустив.", "Скажи текстом — додам у список."),
    "bill_skip_":    ("Більше не нагадуватиму про рахунок {subject}.",
                      "✅ Так, не нагадуй", "↩️ Ні, нагадуй далі",
                      "🚫 Нагадування про рахунок вимкнено.", "Повернути: /рахунки"),
    "dl_skip_":      ("Прибираю дедлайн {subject} — нагадувань про нього не буде.",
                      "✅ Так, прибери", "↩️ Ні, залиш",
                      "🚫 Дедлайн прибрано.", "Скажи текстом — поверну дедлайн."),
    "dm_skip_":      ("Пропускаю цю рекомендацію {subject} — нагадувати не буду.",
                      "✅ Так, пропусти", "↩️ Ні, залиш",
                      "🚫 Пропустив.", "З'явиться знову в наступному аналізі."),
    "fu_skip_":      ("Більше не нагадуватиму, що на лист {subject} немає відповіді.",
                      "✅ Так, не нагадуй", "↩️ Ні, нагадуй",
                      "🚫 Follow-up вимкнено.", "Повернеться, якщо напишеш мені про цей лист."),
    "vr_skip_":      ("Пропускаю рахунок {subject} — нагадування вимикаю.",
                      "✅ Так, пропусти", "↩️ Ні, нагадуй",
                      "🚫 Пропустив.", "Повернути: /рахунки"),
    "wr_skip_":      ("Пропускаю цей пункт тижневого огляду: {subject}.",
                      "✅ Так, пропусти", "↩️ Ні, залиш",
                      "🚫 Пропустив.", "З'явиться в наступному огляді."),
    "rp_skip_":      ("Прибираю це тренування з плану бігу: {subject}.",
                      "✅ Так, прибери", "↩️ Ні, залиш",
                      "🚫 Тренування прибрано.", "Повернути: /план_бігу"),
    "pa_skip_":      ("Відхиляю цю пропозицію: {subject}. Нагадувати не буду.",
                      "✅ Так, відхили", "↩️ Ні, залиш",
                      "🚫 Відхилено.", "Запропоную знову, якщо стане актуально."),
    "email_keep_":   ("Залишаю лист {subject} у скриньці і закриваю тему — "
                      "більше про нього не нагадаю.",
                      "✅ Так, залиш", "↩️ Ні, повернись до листа",
                      "📥 Залишив у скриньці.", "Лист на місці — знайду за запитом."),
    # ── «записувати» ─────────────────────────────────────────────────────────
    "cal_add_":      ("Запишу {subject} у твій Google Calendar.",
                      "✅ Так, запиши", "↩️ Ні, не треба",
                      "📅 Записав у календар.", "Видалити можна прямо в Google Calendar."),
    "calrem_add_":   ("Поставлю нагадування {subject} у календар.",
                      "✅ Так, постав", "↩️ Ні, не треба",
                      "⏰ Нагадування поставив.", "Вимкнути: /вимкнені_нагадування"),
    "email_cal_":    ("Створю подію з листа {subject} у календарі.",
                      "✅ Так, створи", "↩️ Ні, не треба",
                      "📅 Подію створено.", "Видалити можна в Google Calendar."),
    "bill_cal_":     ("Запишу оплату {subject} у календар.",
                      "✅ Так, запиши", "↩️ Ні, не треба",
                      "📅 Записав.", "Видалити можна в Google Calendar."),
    "dl_cal_":       ("Запишу дедлайн {subject} у календар.",
                      "✅ Так, запиши", "↩️ Ні, не треба",
                      "📅 Записав.", "Видалити можна в Google Calendar."),
    "wr_cal_":       ("Запишу {subject} у календар на наступний тиждень.",
                      "✅ Так, запиши", "↩️ Ні, не треба",
                      "📅 Записав.", "Видалити можна в Google Calendar."),
    "pa_cal_":       ("Запишу {subject} у календар.",
                      "✅ Так, запиши", "↩️ Ні, не треба",
                      "📅 Записав.", "Видалити можна в Google Calendar."),
    "pa_rem_":       ("Поставлю нагадування {subject}.",
                      "✅ Так, постав", "↩️ Ні, не треба",
                      "⏰ Поставив.", "Вимкнути: /вимкнені_нагадування"),
    "bill_rem_":     ("Поставлю нагадування про оплату {subject}.",
                      "✅ Так, постав", "↩️ Ні, не треба",
                      "⏰ Поставив.", "Вимкнути: /вимкнені_нагадування"),
    "dl_rem_":       ("Поставлю нагадування про дедлайн {subject}.",
                      "✅ Так, постав", "↩️ Ні, не треба",
                      "⏰ Поставив.", "Вимкнути: /вимкнені_нагадування"),
    ...
    "email_star_":   ("Позначу лист {subject} як важливий — буду про нього нагадувати.",
                      "✅ Так, познач", "↩️ Ні, не треба",
                      "⭐ Позначив як важливий.", "Зняти позначку можна в Gmail."),
    # ── «оплачено / зроблено» ────────────────────────────────────────────────
    "bill_paid_":     ("Позначу рахунок {subject} як оплачений — нагадувань більше не буде.",
                       "✅ Так, оплачено", "↩️ Ні, ще не платив",
                       "💸 Позначив як оплачений.", "Повернути: /рахунки"),
    "bill_due_paid_": ("Позначу рахунок {subject} як оплачений — нагадувань більше не буде.",
                       "✅ Так, оплачено", "↩️ Ні, ще не платив",
                       "💸 Позначив як оплачений.", "Повернути: /рахунки"),
    "vr_paid_":       ("Позначу рахунок {subject} як оплачений — нагадувань більше не буде.",
                       "✅ Так, оплачено", "↩️ Ні, ще не платив",
                       "💸 Позначив як оплачений.", "Повернути: /рахунки"),
    "dl_due_done_":   ("Закрию дедлайн {subject} як виконаний — нагадувати перестану.",
                       "✅ Так, зроблено", "↩️ Ні, ще ні",
                       "✅ Закрив дедлайн.", "Скажи текстом — поверну."),
    # ── надсилання листів (незворотно) ───────────────────────────────────────
    "email_send_":   ("Надішлю цю відповідь {subject} прямо зараз. Відкликати лист я не зможу.",
                      "✅ Так, надішли", "↩️ Ні, не надсилай",
                      "📤 Надіслано.", "Відкликати лист неможливо."),
    "fu_send_":      ("Надішлю follow-up {subject} прямо зараз.",
                      "✅ Так, надішли", "↩️ Ні, не надсилай",
                      "📤 Надіслано.", "Відкликати лист неможливо."),
    "vr_send_":      ("Надішлю це повідомлення {subject} прямо зараз.",
                      "✅ Так, надішли", "↩️ Ні, не надсилай",
                      "📤 Надіслано.", "Відкликати лист неможливо."),
    "pm_send_":      ("Надішлю це повідомлення {subject} прямо зараз.",
                      "✅ Так, надішли", "↩️ Ні, не надсилай",
                      "📤 Надіслано.", "Відкликати лист неможливо."),
}

# Ці кнопки вже перепитують усередині своїх обробників — гейт їх не чіпає,
# інакше Олег отримав би два питання підряд.
_CONFIRM_GATE_SKIP = ("cw_cancel_", "cw_miss_", "gx_mute_", "gx_later_",
                      "email_delete_", "calrem_skip_", "cfm_")


def _cfm_h_gate(raw_data):
    """Підтверджено → віддаємо оригінальний callback назад у роутер."""
    return {"ok": True, "redispatch": raw_data}


def _gate_name(prefix: str) -> str:
    return "gate_" + prefix.strip("_")


try:
    import confirm as _cfm_gate_reg
    for _gp, _gt in _CONFIRM_GATE.items():
        _cfm_gate_reg.register(
            _gate_name(_gp), _cfm_h_gate,
            question=_gt[0], yes=_gt[1], no=_gt[2], done=_gt[3], revert=_gt[4],
        )
except Exception as _cfm_gate_err:
    print(f"[confirm] gate register error: {_cfm_gate_err}")
...
def handle_command(chat_id, text):
    ...
    if text in ["/start", "start"]:
        ...
        try:
            ...
            send(chat_id, f"🤖 <b>AI ПО КАЛЕНДАРЮ</b>\n━━━━━━━━━━━━━━━━━━━━\n"
                          f"Згенеровано сьогодні: <b>{_cw_b._ai_used_today()}</b> AI-коментарів\n"
                          f"Ліміт: <b>немає</b> ♾️\n\n"
                          f"<i>AI пише окремий коментар на КОЖНИЙ етап нагадування "
                          f"(за 3 дні / за добу / за 2 год / за 30 хв / після), плюс висновки "
                          f"в агенді дня, прев'ю на завтра і огляді тижня.</i>")
    ...
    # ─── РЕЖИМ ТИШІ (ТІЛЬКИ ВРУЧНУ, авто-вихід о 04:00) ──────────────────────
    # Олег: «тиша працює тільки коли я введу /тиша, а о 04:00 бот сам
    # відновлюється». Ніякої автоматики за графіком змін.
    elif text in ["/тиша", "тиша", "/розумна_тиша"]:
        try:
            import quiet as _q
            r = _q.sleep_on()
            u = r.get("until")
            ...
            send(chat_id,
                 ...
                 "━━━━━━━━━━━━━━━━━━━━\n"
                 f"Тиша до <b>{when}</b> (≈{(r.get('hours') or 0):.1f} год) — "
                 "далі я сам відновлюсь.\n\n"
                 "🔕 Не буде сповіщень і нагадувань\n"
                 "🤖 AI вимкнений — кредити не витрачаються\n"
                 "📥 Усе несрочне складаю в чергу і віддам після пробудження\n"
                 "✅ Твої команди працюють як звично\n\n"
                 "<i>Вийти раніше: /прокинувся · стан: /тиша_статус</i>")
        except Exception as e:
            send(chat_id, f"⚠️ Не вдалось увімкнути режим тиші: {e}")

    elif text in ["/тиша_статус", "/quiet_status", "тиша статус"]:
        try:
            import autoquiet as _aq
            send(chat_id, _aq.status_text())
        except Exception as e:
            send(chat_id, f"⚠️ Не вдалось прочитати стан тиші: {e}")

    elif text in ["/покажи_відкладене", "покажи відкладене", "/відкладене",
                  "/held"]:
        try:
            import autoquiet as _aq
            n = _aq.pending()
            if not n:
                send(chat_id, "📭 Черга порожня — я нічого не відкладав.")
            else:
                _aq.flush(force=True)
        except Exception as e:
            send(chat_id, f"⚠️ Не вдалось віддати відкладене: {e}")
            ...
            if data.startswith("cfm_y_"):
                ...
                if r.get("ok"):
                    ...
                    if r.get("redispatch"):
                        ...
                        try:
                            _cb2 = dict(cb)
                            _cb2["data"] = r["redispatch"]
                            print(f"[confirm] gate: виконую {r['redispatch']}", flush=True)
                            _route_callback(_cb2, confirmed=True)
...
def _gate_subject(cb, data: str) -> str:
    ...
    try:
        ...
        for row in kb:
            for b in row:
                if b.get("callback_data") == data:
                    ...
                    # прибираємо емодзі-префікс кнопки, лишаємо суть
        ...
        pass
    try:
        first = str((cb.get("message") or {}).get("text") or "").strip().split("\n")[0]
        return first[:60]
    except Exception:
        return ""
...
def _confirm_gate(cb, data: str) -> bool:
    ...
    if not data or any(data.startswith(p) for p in _CONFIRM_GATE_SKIP):
        return False
    pref = ""
    for p in _CONFIRM_GATE:
        if data.startswith(p) and len(p) > len(pref):
            pref = p
    if not pref:
        return False
    try:
        import confirm as _cfmg
        ...
        # Гейт ніколи не має ламати кнопку — у найгіршому разі працює як раніше.
        print(f"[confirm] gate error for {data}: {e}", flush=True)
        return False
