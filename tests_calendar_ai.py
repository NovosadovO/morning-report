...
prompts = " ".join(GEM)
# Правило: рутина/зміна не отримують ВЛАСНИЙ AI-коментар. У блоці "КОНТЕКСТ"
# зміна згадуватись МАЄ — AI мусить знати, що Олег того дня на нічній.
_own = [g for g in GEM if "ПОДІЯ: 🍵 Чай" in g or "ПОДІЯ: 🌙 Нічна зміна" in g]
ck(not _own, "рутина/зміна не отримують власний AI-коментар")
ck(all("Тестова AI-порада" not in t for t, _ in SENT if "Чай" in t or "Нічна зміна" in t),
   "у карточці рутини/зміни немає AI-блоку")
