...
def _ai_note(ev, stage: str, events=None) -> str:
    ...
    prompt = (
        ...
        "у зміни; цілі: фінансова незалежність, схуднення до 75 кг, біг, інвестиції).\n"
...
def _ai_digest(text_block: str, kind: str) -> str:
    ...
    prompt = (
        ...
        "цілі: фінансова незалежність, схуднення до 75 кг, біг, інвестиції).\n"
        ...
        "зваж навантаження і зміни, згадай його цілі (біг, вага 75 кг, інвестиції).\n"
...
def do_focus(pid) -> dict:
    ...
    prompt = (
        ...
        "фінансова незалежність, схуднення до 75 кг, біг, інвестиції).\n"
...
def do_run(pid) -> dict:
    ...
    prompt = (
        ...
        "18:00-06:00; вага ~83 кг, цiль 75 кг).\n"
