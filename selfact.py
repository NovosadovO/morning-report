...
SCAN_GAP_MIN = 90          # не частіше, ніж раз на 1.5 години
MAX_ACTIONS = 2            # максимум дій за один прохід
...
Дозволені дії (обери 0-2 найкорисніші, або поверни [] якщо реальної причини немає):
