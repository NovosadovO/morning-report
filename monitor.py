...
def _get_astro_ai_analysis(astro_text: str, gemini_key: str, shift_hint: str = "") -> str:
    ...
    prompt = f"""Ти експерт-астролог. Проаналізуй НАТАЛЬНУ КАРТУ Олега Новосадова (22.09.1989, 02:52, Львів).
Сьогодні: 24.06.2026, Косіце, Словаччина.

🔮 НАТАЛЬНА КАРТА (ТОЧНІ ГРАДУСИ):
☉ Сонце 28°55' Діва III дім | ☽ Місяць 27°11' Близнюки XI | ☿ Меркурій Rx 5°2' Терези III
...
♇ Плутон 13°22' Скорпіон IV | ☊ Північний вузол 25°20' Водолій VIII | ☋ Південний вузол 25°20' Лев II

🔴 КРИТИЧНІ КВАДРАТУРИ (напруга, боротьба, трансформація):
1. ☉ Сонце ◻ ☽ Місяць (ОРБ 1.73°!) → ТОЧНА воля vs емоції. Раціональність Діви конфліктує з чуттєвістю Близнюків. Сьогодні: усвідомити емоції, не гнати їх в собі.
2. ☉ ◻ ♅ Уран (2.48°) → творче samovirazhення vs революційні імпульси. Непередбачені повороти.
3. ☿ Меркурій ◻ ♄/♅/♆ (ТРІЙНА!) → розум затиснутий (Сатурн), хоче революції (Уран) й духовності (Нептун). Сьогодні: медитація, аналіз, не просто дія.
4. ♂ Марс ◻ ♅ (0.12° - ТОЧНА!) → енергія vs Козеріг-система. Дисципліна + дія = вибух творчості.

🟢 ЧУДЕСНІ ТРИГОНИ (дари, удача, потік):
1. ♀ Венера ◇ ♃ Юпітер (2.24°!) → удача у коханні, грошах! Щедрість серця розширює можливості.
2. ♀ ◇ ♆ Нептун (1.34° - ТОЧНА!) → мистицизм, емпатія, глибина. Розумієш душу людей.
3. ♃ Юпітер ◇ ♇ Плутон (4.66°) → духовна трансформація. Доступ до глибин.

🔵 ОПОЗИЦІЇ (баланс, свідомість):
1. ☽ ☍ ♅ (4.21°) → емоції vs інновації. Слухай обидві сторони.
2. ♃ ☍ ♄/♆ (0.90°!) → духовність vs матеріал. Баланс під контролем.

⚪ ПОТУЖНІ СОЕДИНЕННЯ (концентрація):
1. ☉ ☌ ☿ ☌ ♂ (ТРІЙНА!) → УМ=ВОЛЯ=КОМУНІКАЦІЯ. Інтелектуальний лідер.
2. ♀ ☌ ♇ (2.42°) → ЕРОТИЧНА ГЛИБИНА, психо-магнетизм.
3. ♄ ☌ ♅ ☌ ♆ (ТРІЙНА VI дім!) → ЦЕ ТВІЙ ЦЕНТР! Дисципліна+революція+духовність = твій ДЕСТИНЕЙ. Ти зміняєш систему зсередини.

📊 АНАЛІЗ НАТАЛЬНОЇ КАРТИ:
• ХАРАКТЕР: аналітик-революціонер. Геніальність або паралич — твій вибір.
• РОБОТА/ЗДОРОВ'Я (VI дім трійна стеллія) = твій ДЕСТИНЕЙ. Система потребує змін.
• СТОСУНКИ (Венера-Плутон) = захоплюючі, глибокі. Не поверхнево.
• ФІНАНСИ (Венера трин Юпітер) = удача ЯКЩО працюєш дисціпліновано.
• ДУХОВНІСТЬ (Нептун VI) = інтуїція у роботі. Сьогодні слухай її!

НАПИШИ 350-400 слів. ГЛИБОКИЙ аналіз ЦИХ АСПЕКТІВ, ДОМІВ, КОМБІНАЦІЙ. Що вони ОЗНАЧАЮТЬ для Олега СЬОГОДНІ.
Не загальні фрази, а КОНКРЕТНА практична інтерпретація. УКРАЇНСЬКОЮ.
