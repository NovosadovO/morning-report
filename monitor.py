...
def _get_astro_ai_analysis(astro_text: str, gemini_key: str, shift_hint: str = "") -> str:
    """AI аналіз астро-аспектів і домів натальної карти Олега — ТОЧНА КАРТА."""
    if not astro_text or not gemini_key:
        return ""
    
    print(f"[astro_ai] generating analysis...", flush=True)
    
    # РОЗШИРЕНИЙ промпт з ТОЧНОЮ натальною картою Олега
    prompt = f"""Ти експерт-астролог для Олега Новосадова (народження 22.09.1989 о 02:52, Львів, Україна).
Сьогодні Олег перебуває в Косіце, Словаччина (24.06.2026).

ТОЧНА НАТАЛЬНА КАРТА ОЛЕГА (ВИПРАВЛЕНА):
━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
🪐 ОСНОВНІ ПЛАНЕТИ:
  ☉ Сонце:      28°55' ♍ ДІВА III дім (аналіз, мова, розум)
  ☽ Місяць:     27°11' ♊ БЛИЗНЮКИ XI дім (комунікація, дружба, очікування)
  ☿ Меркурій Rx: 9°36' ♎ ТЕРЕЗИ III дім (думка, спілкування, медитація)
  ♀ Венера:     13°22' ♏ СКОРПІОН IV дім (глибокі емоції, дім, психо-трансформація)
  ♂ Марс:       1°30'  ♎ ТЕРЕЗИ III дім (воля, енергія, дискусії)
  ♃ Юпітер:     8°42'  ♋ РАК XII дім (духовність, усамітнення, скриті таланти)
  ♄ Сатурн:     10°56' ♑ КОЗЕРІГ VI дім (робота, здоров'я, дисципліна) ⚠️
  ♅ Уран:       25°20' ♑ КОЗЕРІГ VI дім (революція, новаторство, технології) ⚠️
  ♆ Нептун:     7°23'  ♑ КОЗЕРІГ VI дім (духовність у роботі, почуття) ⚠️
  ♇ Плутон:     25°6'  ♏ СКОРПІОН IV дім (психі-трансформація, керування)
  ☊ Північний вузол: ♒ ВОДОЛІЙ VIII дім (еволюція душі через спільні ресурси)
  ☋ Південний вузол: ♌ ЛЕВ II дім (кармічна спадщина творчості, влади)
  ⚷ Хірон:      ♋ РАК XII дім (ранення ціндра, гілка духовності)
  ⚸ Ліліта:      ♎ ТЕРЕЗИ IV дім (неприйнята раціональність, психи-побут)

🏠 КЛЮЧОВІ ДОМА:
  ASC (I):      1°2'   ♈ Овен (новаторство, енергія, особистість)
  X дім (MC):   8°30'  ♏ Скорпіон (карєра у трансформації, психо-професія)
  VII дім:      1°2'   ♉ Телець (партнери, практичність, вірність)
  VIII дім:     18°5'  ♋ Рак (спільні ресурси, психологія, спадщина)
  V дім:        17°21' ♎ Терези (творчість, баланс, романтика)
  XII дім:      ГУСТИЙ (Юпітер+Хірон) — духовна криза, потреба усамітнення

⚠️ КЛЮЧОВА КОНФІГУРАЦІЯ:
 👑 Трійна Козеріг у VI домі (♄+♅+♆) = РОБОТА + ЗДОРОВ'Я в центрі долі
    → Дисципліна, революція, духовність у професії
    → Потреба системності, але тяга до змін
 🔥 Венера+Плутон в Скорпіоні = ГЛИБОКІ ЕМОЦІЙНІ ТРАНСФОРМАЦІЇ
    → Стосунки як еволюція, психо-дослідження
 💭 Сонце+Меркурій Rx+Марс в Дівах/Терезах = АНАЛІТИЧНИЙ УМ
    → Критичність, комунікація, дебати, рефлексія

🌍 ПОТОЧНІ ТРАНЗИТИ НА 24.06.2026 (КОСІЦЕ, СЛОВАЧЧИНА):
━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
Це КРИТИЧНІ аспекти для Олега СЬОГОДНІ:

📡 КЛЮЧОВІ ТРАНЗИТИ → НАТАЛЬНІ ПЛАНЕТИ:
  • Транзитний ♅ УРАН (Близнюки) △ натальний ☿ МЕРКУРІЙ (Терези III дім)
    → ТРИН (120°) — ТОЧКА ПРОЗРІННЯ, нові ідеї, технологічні інсайти
       Смисл: твій розум готовий до революційних думок, комунікація прояснюється,
       можливі раптові озарення про крипто/інвестиції. ПОЗИТИВНИЙ ДЕНЬ для переговорів.
  
  • Транзитна ♀ ВЕНЕРА (Лев) △ натальна ♀ ВЕНЕРА (Скорпіон IV дім)
    → ТРИН — ГАРМОНІЯ в стосунках, фінансах, творчості
       Смисл: день добрий для: (а) переговорів про гроші, (б) спілкування з близькими,
       (в) інвестиційних рішень. Емоційна рівновага, можешь довіряти інтуїції.
  
  • Транзитний ♂ МАРС (Рак) ◻ натальна ♄ САТУРН (Козеріг VI дім)
    → КВАДРАТУРА (90°) — НАПРУГА, опір, бажання діяти vs обмеження
       Смисл: день требует ДИСЦИПЛІНИ у роботі. Можливі затримки, але вона — твій учитель.
       Не кидай проекти, натомість: систематизуй, аналізуй, довіршай незакінчене.
  
  • Транзитний ☊ ПІВНІЧНИЙ ВУЗОЛ (Рак) ◇ натальна ☋ ПІВДЕННИЙ ВУЗОЛ (Лев II)
    → ТОЧКА ЕВОЛЮЦІЇ, ОСИ ДОЛІ активна
       Смисл: сьогодні твоя доля шепоче про ПОДІЛ, про допомогу іншим.
       Якщо розглядаєш фінансові рішення — думай про колективне благо, а не тільки себе.

АНАЛІЗУЙ КОНКРЕТНО (ГЛИБИНА):
1️⃣ ВПЛИВ Діви (Сонце) + Терез (Меркурій, Марс) на його характер:
   - Аналітик, критичний розум, потреба до совершенства
   - Aber: Меркурій Rx = замкнутість при спілкуванні, внутрішні монологи
   - СЬОГОДНІ: транзитний Уран розпалює твій Меркурій → РОЗМОВИ/НАПИСИ будуть гострі й інноваційні
   
2️⃣ КОЗЕРІГ VI дім (трійна стеллія ♄♅♆):
   - Робота = ЦЕНТР його еволюції, але скованість + потреба до змін
   - Здоров'я = вимагає дисципліни, проте духовна інтуїція допоможе
   - СЬОГОДНІ: Марс напирає на Сатурн → день РОБІТ, СПИСКІВ, АНАЛІЗУ (не лінується!)
   - Стиль: систематичний, але вольовий революціонер
   
3️⃣ СКОРПІОН (Венера, Плутон, MC):
   - Емоційна глибина, психо-трансформація у всіх сферах
   - Карєра: можлива у психології, фінансах, дослідженнях, містиці
   - СЬОГОДНІ: Венера в гармонії → стосунки/гроші легші, прийми пропозиції з благодатю
   
4️⃣ БЛИЗНЮКИ (Місяць XI) + спілкування:
   - Потреба до дружби, комунікації, групи (але XII-усамітнення)
   - СЬОГОДНІ: Уран у Близнюках ← ТВОЯ сфера! Спілкування з друзями буде незвичне й цікаве.
   
5️⃣ ВУЗЛИ ДОЛІ (Водолій VIII ← Лев II):
   - Еволюція: від персональної творчості/влади → до колективного дослідження спільних ресурсів
   - СЬОГОДНІ: вузли активні → думай МІЛЬЙОНІВ, не копійок. Яку вартість ти додаєш світу?
   
6️⃣ ДУХОВНА ФАЗА:
   - Дар медитації, глибоких прозрінь
   - СЬОГОДНІ: ідеальний день для СТРАТЕГІЧНИХ РІШЕНЬ (інвестицій, змін у роботі)
     Довіршай інтуїції, вона點準 сьогодні.

⚡ ПІДСУМОК ДНЯЯ (24.06.2026):
Гарний день для КОМУНІКАЦІЇ, ГРОШЕЙ і РІШЕНЬ. Уран розпалює твій розум, Венера даруєт гармонію.
Але САТУРН нагадує про дисципліну — робота須мість, не кидай в поспіху. Прийми всім серцем.

ФОРМАТ: 350-400 слів, глибиний аналіз, УКРАЇНСЬКОЮ, практичні висновки для Олега СЬОГОДНІ.
БЕЗ общих фраз, КОНКРЕТНО про його конфігурацію + СЬОГОДНІШНІ ТРАНЗИТИ.
...
def main():
    ...
    def _send_album(photos):
        """Надсилає фото в Telegram по одному (надійний метод)."""
        if not photos:
            return
        try:
            for i, p in enumerate(photos):
                ...
                if r.status_code == 200:
                    print(f"[photo_album] photo {i+1}/{len(photos)} ✅ sent", flush=True)
                else:
                    print(f"[photo_album] photo {i+1} ❌ error {r.status_code}: {r.text[:100]}", flush=True)
                
                _time_main.sleep(0.3)
        except Exception as e:
