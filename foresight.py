...
_PROFILE = ("Олег Новосадов, Кошице (Словаччина). Працює на Minebea Mitsumi "
            ...
            "вага з 83-84 кг до 75 кг, фінансова незалежність, інвестиції "
...
def _shift_brief() -> str:
    ...
    prompt = (
        ...
        "щоб не втратити прогрес до 75 кг.\n\n"
...
def _gap_brief() -> str:
    ...
    for offset in (0, 1):
        ...
        prompt = (
            ...
            "(ціль схуднення 75 кг), конкретну справу з незакритого, або "
...
_LIFE_POOL = [
    ...
    "нова страва на здорове харчування (ціль 75 кг) на вихідні",
