...
# FORCE DEBUG — видалити після тестування!
import sys as _debug_sys
print(f"[STRAVA_CHARTS] LOADED from: {__file__}", file=_debug_sys.stderr, flush=True)
print(f"[STRAVA_CHARTS] Using ACCENT={ACCENT}, TEXT={TEXT_COLOR}", file=_debug_sys.stderr, flush=True)
