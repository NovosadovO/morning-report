...
SETS = {
    ...
    # «Чи вдалося досягти результату / чи потрібна допомога?»
    "result": [("done", "✅ Вдалося"), ("help", "🤝 Потрібна допомога"),
               ("progress", "⏳ Ще в процесі")],
...
MEANS = {
    ...
    "help": "попросив допомогу",
    "progress": "сказав, що ще в процесі",
}
...
ACK = {
    ...
    "help": "🤝 Записав: потрібна допомога. Запропоную рішення.",
    "progress": "⏳ Добре, ще в процесі — запитаю пізніше.",
}
