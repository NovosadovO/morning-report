...
ANGLES = [
    ...
    "— АЛЕ ніколи не оголошуй суперечність на основі значення, позначеного "
    "в даних як ⚠️ ЗАФІКСОВАНО СЬОГОДНІ/МОЖЕ БУТИ ЧАСТКОВИМ: часткове "
    "число само по собі нічого не доводить",
